// XP and Leveling System for Izzy Reads
...
export const LEVELS: Level[] = [
  ...
  { level: 13, title: 'Legendary Bookworm', minXP: 6200, maxXP: 7600, icon: '🐉' },
  { level: 14, title: 'Mythic Scholar', minXP: 7600, maxXP: 9200, icon: '🌙' },
  { level: 15, title: 'Grand Librarian', minXP: 9200, maxXP: 11000, icon: '🏛️' },
  { level: 16, title: 'Keeper of Tales', minXP: 11000, maxXP: 13000, icon: '📖' },
  { level: 17, title: 'Eternal Reader', minXP: 13000, maxXP: 15500, icon: '♾️' },
  { level: 18, title: 'Timeless Scholar', minXP: 15500, maxXP: 18500, icon: '⏳' },
  { level: 19, title: 'Cosmic Bookkeeper', minXP: 18500, maxXP: 22000, icon: '🌌' },
  { level: 20, title: 'Ultimate Bibliophile', minXP: 22000, maxXP: Infinity, icon: '💎' },
]
