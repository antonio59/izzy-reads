// Achievement System for Izzy Reads
...
export interface Achievement {
  ...
  requirement: {
    type: 'books_read' | 'pages_read' | 'streak_days' | 'genres_read' | 'poems_written' | 'posts_written' | 'rating_given' | 'challenge_complete'
    value: number
  }
  xpReward: number
...
export function checkAchievementProgress(achievement: Achievement, stats: UserStats): { unlocked: boolean; progress: number } {
  let current = 0
