...
const AboutMe = ({ aboutData }: AboutMeProps) => {
  if (!aboutData.isPublished) {
    return (
      <div className="max-w-4xl mx-auto">
        <div className="text-center py-20 bg-white/80 backdrop-blur-sm rounded-4xl shadow-xl border-4 border-purple-200">
          ...
          <h3 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-3 font-display">About Me - Coming Soon!</h3>
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      <h2 className="text-4xl md:text-5xl font-bold mb-10 text-center flex items-center justify-center gap-4 font-display">
      ...
      <div className="relative">
        <div className="absolute -inset-1 bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 rounded-4xl blur-lg opacity-50"></div>
        <div className="relative bg-gradient-to-r from-violet-500 via-purple-500 to-fuchsia-500 rounded-4xl p-8 text-white shadow-xl overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
            <div className="flex-shrink-0 relative">
              ...
              {aboutData.profilePhoto ? (
                ...
                <div className="relative w-36 h-36 rounded-full bg-white/30 backdrop-blur-md border-4 border-white shadow-xl flex items-center justify-center">
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-3xl font-bold mb-4 flex items-center justify-center md:justify-start gap-3 font-display">
          ...
          <div className="group relative" style={{ animation: 'slide-up 0.5s ease-out 0.1s both' }}>
            ...
            <div className="relative bg-white/95 backdrop-blur rounded-3xl shadow-xl p-6 border-4 border-blue-100 hover:border-blue-300 transition-all hover:scale-[1.02]">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-xl font-bold text-stone-800 font-display">Currently Reading</h3>
              </div>
        ...
        <div className="group relative" style={{ animation: 'slide-up 0.5s ease-out 0.2s both' }}>
          ...
          <div className="relative bg-white/95 backdrop-blur rounded-3xl shadow-xl p-6 border-4 border-pink-100 hover:border-pink-300 transition-all hover:scale-[1.02]">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-stone-800 font-display">Why I Love Reading</h3>
            </div>
        ...
        <div className="group relative" style={{ animation: 'slide-up 0.5s ease-out 0.3s both' }}>
          ...
          <div className="relative bg-white/95 backdrop-blur rounded-3xl shadow-xl p-6 border-4 border-purple-100 hover:border-purple-300 transition-all hover:scale-[1.02]">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-stone-800 font-display">Favorite Genres</h3>
            </div>
        ...
        <div className="group relative" style={{ animation: 'slide-up 0.5s ease-out 0.4s both' }}>
          ...
          <div className="relative bg-white/95 backdrop-blur rounded-3xl shadow-xl p-6 border-4 border-amber-100 hover:border-amber-300 transition-all hover:scale-[1.02]">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-stone-800 font-display">Favorite Authors</h3>
            </div>
      ...
      {aboutData.funFacts.length > 0 && (
        <div className="relative" style={{ animation: 'slide-up 0.5s ease-out 0.5s both' }}>
          <div className="absolute -inset-1 bg-gradient-to-r from-yellow-300 via-amber-300 to-orange-300 rounded-4xl blur-lg opacity-30"></div>
          <div className="relative bg-gradient-to-br from-yellow-50 via-amber-50 to-orange-50 rounded-4xl shadow-xl p-8 border-4 border-amber-200">
            <h3 className="text-2xl font-bold text-stone-800 mb-6 flex items-center gap-3 font-display">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {aboutData.funFacts.map((fact, idx) => (
                <Card
                  ...
                  variant="default"
                  padding="none"
                  className="group flex items-start gap-4 p-5 shadow-md hover:shadow-xl hover:scale-[1.02] border-2 border-transparent hover:border-amber-200"
        ...
        <div className="relative" style={{ animation: 'slide-up 0.5s ease-out 0.6s both' }}>
          ...
          <div className="relative bg-white/95 backdrop-blur rounded-3xl shadow-xl p-8 border-4 border-emerald-100">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-stone-800 font-display">My Reading Goals</h3>
            </div>
      ...
      {aboutData.achievements.length > 0 && (
        <div className="relative" style={{ animation: 'slide-up 0.5s ease-out 0.7s both' }}>
          <div className="absolute -inset-1 bg-gradient-to-r from-blue-300 via-indigo-300 to-purple-300 rounded-4xl blur-lg opacity-30"></div>
          <div className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-4xl shadow-xl p-8 border-4 border-indigo-200">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-stone-800 font-display">Reading Achievements</h3>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {aboutData.achievements.map((achievement, idx) => (
                <Card
                  ...
                  variant="default"
                  padding="none"
                  className="group p-5 shadow-md border-3 border-indigo-100 hover:border-indigo-300 hover:shadow-xl hover:scale-105"
