      ...
      <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-2xl p-6 flex items-center gap-4">
        ...
        <div>
          <h3 className="text-xl font-bold text-stone-800">
            Your Reading Bookworm!
          </h3>
          <p className="text-stone-600">
            You've read{" "}
            <span className="font-bold text-purple-600">
              {books.filter((b) => b.isRead).length}
            </span>{" "}
            books! Keep reading to help your bookworm grow! 🌟
          </p>
        </div>
      </div>
            ...
            >
              ...
              >
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-amber-100 to-amber-50">
                    {selectedBook.coverUrl ? (
                      ...
                      <div
                        className={`w-full h-full bg-gradient-to-br ${getSpineColor(0)} flex flex-col items-center justify-center p-8`}
                      >
                ...
                <motion.div
                  ...
                  style={{
                    backgroundImage:
                      "repeating-linear-gradient(transparent, transparent 31px, #e5d5c5 31px, #e5d5c5 32px)",
                ...
                >
                  ...
                  <div className="mt-8 pt-6 border-t border-amber-200 text-center">
                    ...
                    <p className="text-sm text-stone-500 mt-2">
                      From Izzy's Reading Collection
                    </p>
                  </div>
                </motion.div>
              </div>
